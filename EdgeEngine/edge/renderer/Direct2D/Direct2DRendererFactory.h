...
#ifndef __DIRECT2D_RENDERER_FACTORY_H_H__
#define __DIRECT2D_RENDERER_FACTORY_H_H__

#include <renderer/IRendererFactory.h>

NS_EDGE_BEGIN

class EDGE_DLL Direct2DRendererFactory final : public IRendererFactory
{
public:
...
#endif // __DIRECT2D_RENDERER_FACTORY_H_H__